...
| fn              | Vaccination Certificate Batch Number (fine)      | 123456789                                        | Fine issuing batch number for the certificate (can be used for revocation), not to be confused with vaccine batch number |
| g               | Given Name                                       | Miriam                                           |                                                                                                                            |
...
| d2/vv           | Dose 2 - Vaccine vendor                          | Pfizer                                           | Human readable name of vaccine manufacturer                                                                                |
